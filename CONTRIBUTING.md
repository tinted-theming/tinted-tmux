...
arg the path to `tinted-tmux` repository: `./base16-builder-go
-template-dir ../tinted-tmux`

Or the above steps represented in shell commands:

```shell 
cd /path/to/tinted-tmux/../ # This repos parent dir 
...
base16-builder-go \
  ...
  -template-dir /path/to/tinted-tmux
```
